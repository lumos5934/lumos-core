...
<br>
Dimmer Canvas 를 할당하면 해당 최상위 UI 가 Modal 일 경우 자동으로 Dimmer Canvas 이동.

<br>

<table>
  <tr>
    <td><b>Open(Action onBeforeOpen)<b></td>
    <td>해당 타입의 팝업을 Open. Open 이전에 수행해야하는 동작은 델리게이트로 전달</td>
  </tr>
        <tr>
    <td><b>Close<b></td>
